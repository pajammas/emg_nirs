...
function [TrainErr,TestErr,TrainPredict,TestPredict] = knnclassifyuser(TrainData,TestData,TrainClass,TestClass)

% if nargin < 5
%     K = 1;
% end
TrainPredict = knnclassify(TrainData,TrainData,TrainClass);
TestPredict = knnclassify(TestData,TrainData,TrainClass);
